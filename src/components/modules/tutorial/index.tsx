    ...
    <section className="pb-32 pt-10">
      <div className="container flex flex-col items-center gap-2 lg:px-16">
        <Breadcrumb pageName="Tutorials"
          pageDescription="Learn coding with ease through our practical, step-by-step tutorials. From beginner to advanced levels, explore guides that help you build projects and master essential skills in software development."
        />
